...
export interface ApiProductProduct extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    bages: Schema.Attribute.Component<'common.badge', true>;
    ...
    > &
      Schema.Attribute.Private;
    name: Schema.Attribute.String;
    nutrition: Schema.Attribute.Component<'common.nutrition', false>;
    price: Schema.Attribute.Component<'common.price', false>;
    publishedAt: Schema.Attribute.DateTime;
    slug: Schema.Attribute.UID<'name'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
export interface ApiSitePageSitePage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    deliveryContent: Schema.Attribute.RichText;
